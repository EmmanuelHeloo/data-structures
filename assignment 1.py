'''
    Program created by Emmanuel Heloo, 6938221
    My github link is https://github.com/EmmanuelHeloo
'''
import numpy as np
...
x = L/2
print()
print('(c) The point at which the shear force V = 0 is {} .'.format(x))
#Question d
p = 0
s = 0.01
q = L + s
...
print()
print('(g) The relative errors between estimated points of contra-flexure in (b) and (f) are {0}% and {1}% .'.format(r_e1,r_e2))
#Question h
"""
